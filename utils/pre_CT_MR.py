...
nii_path = os.path.join(PROJECT_ROOT, 'data', 'nii_data', 'images')
gt_path = os.path.join(PROJECT_ROOT, 'data', 'nii_data', 'labels')
npy_path = os.path.join(PROJECT_ROOT, 'data', 'preprocessed_npz', prefix[:-1])
