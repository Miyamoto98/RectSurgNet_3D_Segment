...
img_path = os.path.join(PROJECT_ROOT, 'data', 'pred_data', 'images')
gt_path = os.path.join(PROJECT_ROOT, 'data', 'pred_data', 'labels')
npy_path = os.path.join(PROJECT_ROOT, 'data', 'preprocessed_npy', prefix[:-1])
